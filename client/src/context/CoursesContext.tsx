...
// import axios from 'axios'; // use this for Mockaroo API with loadMockarooData()
    ...
    axios
      ...
      .catch((error) => {
        if (error.response && error.response.status === 500) {
          console.log(
            '500 Internal Server Error: Probably no more requests to Mockaroo.com allowed today.'
          );
        } else {
