...
//     <>
//       {sidedisplay && user && (
//         <div className="h-full px-3 py-5 overflow-y-auto border-gray-200 bg-gradient-to-t from-primary-50 to-primary-100 dark:bg-gray-800 dark:border-gray-700">
...
//                   setDisplayPage(5);
//                 }}
//                 className="flex items-center w-full p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-primary-300 dark:hover:bg-gray-700 group"
//               >
//                 <svg
//                   aria-hidden="true"
...
//                   }}
//                   type="button"
//                   className="flex items-center w-full p-2 text-base font-normal text-gray-900 transition duration-75 rounded-lg group hover:bg-primary-300 dark:text-white dark:hover:bg-gray-700"
